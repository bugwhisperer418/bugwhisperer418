...
- ⚙️ **Assembly**: For when you when I'm feeling extra adventurous or trying to reverse engineer how something is working. Still a beginner with ASM, and mostly play with RISC-V and ARM.
- 🇬 **Go Lang**: A sweet middle ground between high-level Python and low-level C/ASM. Type safety and performance.
